...
for aa = 1:length(plate_data.temp_25_total)
    ...
    set(z1, 'MarkerFaceColor', 'w', 'MarkerEdgeColor', 'r')
...
for aa = 1:length(water_data.temp_25_total)
    randVal = .02*randn(1);
    errorbar(1.25+(randVal), water_data.temp_25_total(aa)./10, water_data.temp_25_total_sem(aa)/10, 'r');
    hold on
    z1 = scatter(1.25+(randVal), water_data.temp_25_total(aa)./10, 200);
    set(z1, 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'r')
    
    randVal = .02*randn(1);
    errorbar(2.25+(randVal), water_data.temp_30_total(aa)./10, water_data.temp_30_total_sem(aa)/10, 'r');
    hold on
    z1 = scatter(2.25+(randVal), water_data.temp_30_total(aa)./10, 200);
    set(z1, 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'r')
    
    randVal = .02*randn(1);
    errorbar(3.25+(randVal), water_data.temp_35_total(aa)./10, water_data.temp_35_total_sem(aa)/10, 'r');
    hold on
...
for aa = 1:length(old_data.temp_25_total)
    randVal = .02*randn(1);
    errorbar(1+(randVal), old_data.temp_25_total(aa)./10, old_data.temp_25_total_sem(aa)/10, 'b');
    hold on
    z1 = scatter(1+(randVal), old_data.temp_25_total(aa)./10, 200);
    set(z1, 'MarkerFaceColor', 'b', 'MarkerEdgeColor', 'b')
    
    randVal = .02*randn(1);
    errorbar(2+(randVal), old_data.temp_30_total(aa)./10, old_data.temp_30_total_sem(aa)/10, 'b');
    hold on
    z1 = scatter(2+(randVal), old_data.temp_30_total(aa)./10, 200);
    set(z1, 'MarkerFaceColor', 'b', 'MarkerEdgeColor', 'b')
    
    randVal = .02*randn(1);
    errorbar(3+(randVal), old_data.temp_35_total(aa)./10, old_data.temp_35_total_sem(aa)/10, 'b');
    hold on
    z1 = scatter(3+(randVal), old_data.temp_35_total(aa)./10, 200);
    set(z1, 'MarkerFaceColor', 'b', 'MarkerEdgeColor', 'b')
end
...
set(gca, 'XTick', [1 2 3], 'XTickLabel', {'28(25)' '30' '35'},  'FontSize', 14)

z1 = scatter(1,23, 200)
set(z1, 'MarkerFaceColor', 'k', 'MarkerEdgeColor', 'k')
text(1.08, 23, 'black ball, - reflector')

z1 = scatter(1,22, 200)
set(z1, 'MarkerFaceColor', 'w', 'MarkerEdgeColor', 'k')
text(1.08, 22, 'white ball, - reflector')

z1 = scatter(1,21, 200)
set(z1, 'MarkerFaceColor', 'b', 'MarkerEdgeColor', 'b')
text(1.08, 21, 'last meeting data: bath control + laser')

z1 = scatter(1,20, 200)
set(z1, 'MarkerFaceColor', 'w', 'MarkerEdgeColor', 'r')
text(1.08, 20, 'white ball, + reflector')

z1 = scatter(1,19, 200)
set(z1, 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'r')
text(1.08, 19, 'black ball, + reflector')




box off
cd('/Users/tj_florence/Documents/MATLAB/tetheredMazeLibrary/meeting_analysis_files/05022014/black_ball/')
...
for aa = 1:length(tether_data.temp_25_str)
    randVal = .02*randn(1);
    errorbar(.75+(randVal), tether_data.temp_25_str(aa) , tether_data.temp_25_str_sem(aa) , 'k');
    hold on
    z1 = scatter(.75+(randVal), tether_data.temp_25_str(aa) , 200);
    set(z1, 'MarkerFaceColor', [.2 .2 .2], 'MarkerEdgeColor', 'k')
    
    randVal = .02*randn(1);
    errorbar(1.75+(randVal), tether_data.temp_30_str(aa) , tether_data.temp_30_str_sem(aa) , 'k');
    hold on
    z1 = scatter(1.75+(randVal), tether_data.temp_30_str(aa) , 200);
    set(z1, 'MarkerFaceColor', [.2 .2 .2], 'MarkerEdgeColor', 'k')
    
    randVal = .02*randn(1);
    errorbar(2.75+(randVal), tether_data.temp_35_str(aa) , tether_data.temp_35_str_sem(aa) , 'k');
    hold on
    z1 = scatter(2.75+(randVal), tether_data.temp_35_str(aa) , 200);
    set(z1, 'MarkerFaceColor', [.2 .2 .2], 'MarkerEdgeColor', 'k')
end
...
for aa = 1:length(headfix_data.temp_25_str)
    randVal = .02*randn(1);
    errorbar(.86+(randVal), headfix_data.temp_25_str(aa) , headfix_data.temp_25_str_sem(aa) , 'k');
    hold on
    z1 = scatter(.86+(randVal), headfix_data.temp_25_str(aa) , 200);
    set(z1, 'MarkerFaceColor', 'w', 'MarkerEdgeColor', 'k')
    
    randVal = .02*randn(1);
    errorbar(1.86+(randVal), headfix_data.temp_30_str(aa) , headfix_data.temp_30_str_sem(aa) , 'k');
    hold on
    z1 = scatter(1.86+(randVal), headfix_data.temp_30_str(aa) , 200);
    set(z1, 'MarkerFaceColor', 'w', 'MarkerEdgeColor', 'k')
    
    randVal = .02*randn(1);
    errorbar(2.86+(randVal), headfix_data.temp_35_str(aa) , headfix_data.temp_35_str_sem(aa) , 'k');
    hold on
    z1 = scatter(2.86+(randVal), headfix_data.temp_35_str(aa) , 200);
    set(z1, 'MarkerFaceColor', 'w', 'MarkerEdgeColor', 'k')
end
...
for aa = 1:length(plate_data.temp_25_str)
    randVal = .02*randn(1);
    errorbar(1.15+(randVal), plate_data.temp_25_str(aa) , plate_data.temp_25_str_sem(aa) , 'r');
    hold on
    z1 = scatter(1.15+(randVal), plate_data.temp_25_str(aa) , 200);
    set(z1, 'MarkerFaceColor', 'w', 'MarkerEdgeColor', 'r')
    
    randVal = .02*randn(1);
    errorbar(2.15+(randVal), plate_data.temp_30_str(aa) , plate_data.temp_30_str_sem(aa) , 'r');
    hold on
    z1 = scatter(2.15+(randVal), plate_data.temp_30_str(aa) , 200);
    set(z1, 'MarkerFaceColor', 'w', 'MarkerEdgeColor', 'r')
    
    randVal = .02*randn(1);
    errorbar(3.15+(randVal), plate_data.temp_35_str(aa) , plate_data.temp_35_str_sem(aa) , 'r');
    hold on
    z1 = scatter(3.15+(randVal), plate_data.temp_35_str(aa) , 200);
    set(z1, 'MarkerFaceColor', 'w', 'MarkerEdgeColor', 'r')
end

for aa = 1:length(water_data.temp_25_str)
    randVal = .02*randn(1);
    errorbar(1.25+(randVal), water_data.temp_25_str(aa) , water_data.temp_25_str_sem(aa) , 'r');
    hold on
    z1 = scatter(1.25+(randVal), water_data.temp_25_str(aa) , 200);
    set(z1, 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'r')
    
    randVal = .02*randn(1);
    errorbar(2.25+(randVal), water_data.temp_30_str(aa) , water_data.temp_30_str_sem(aa) , 'r');
    hold on
    z1 = scatter(2.25+(randVal), water_data.temp_30_str(aa) , 200);
    set(z1, 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'r')
    
    randVal = .02*randn(1);
    errorbar(3.25+(randVal), water_data.temp_35_str(aa) , water_data.temp_35_str_sem(aa) , 'r');
    hold on
...
for aa = 1:length(old_data.temp_25_str)
    randVal = .02*randn(1);
    errorbar(1+(randVal), old_data.temp_25_str(aa) , old_data.temp_25_str_sem(aa) , 'b');
    hold on
    z1 = scatter(1+(randVal), old_data.temp_25_str(aa) , 200);
    set(z1, 'MarkerFaceColor', 'b', 'MarkerEdgeColor', 'b')
    
    randVal = .02*randn(1);
    errorbar(2+(randVal), old_data.temp_30_str(aa) , old_data.temp_30_str_sem(aa) , 'b');
    hold on
    z1 = scatter(2+(randVal), old_data.temp_30_str(aa) , 200);
    set(z1, 'MarkerFaceColor', 'b', 'MarkerEdgeColor', 'b')
    
    randVal = .02*randn(1);
    errorbar(3+(randVal), old_data.temp_35_str(aa) , old_data.temp_35_str_sem(aa) , 'b');
    hold on
    z1 = scatter(3+(randVal), old_data.temp_35_str(aa) , 200);
    set(z1, 'MarkerFaceColor', 'b', 'MarkerEdgeColor', 'b')
end
...
z1 = scatter(1,.48, 200)
set(z1, 'MarkerFaceColor', 'k', 'MarkerEdgeColor', 'k')
text(1.08, .48, 'black ball, - reflector')

z1 = scatter(1,.46, 200)
set(z1, 'MarkerFaceColor', 'w', 'MarkerEdgeColor', 'k')
text(1.08, .46, 'white ball, - reflector')

z1 = scatter(1,.44, 200)
set(z1, 'MarkerFaceColor', 'b', 'MarkerEdgeColor', 'b')
text(1.08, .44, 'last meeting data: bath control + laser')

z1 = scatter(1,.42, 200)
set(z1, 'MarkerFaceColor', 'w', 'MarkerEdgeColor', 'r')
text(1.08, .42, 'white ball, + reflector')

z1 = scatter(1,.40, 200)
set(z1, 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'r')
text(1.08, .40, 'black ball, + reflector')
