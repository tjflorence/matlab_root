...
fly2(1).tr1 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-08-29/20132908151837_stimulusTest';
fly2(1).tr2 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-08-29/20132908154115_stimulusTest';

fly2(2).tr1 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-08-29/20132908194128_stimulusTest/';
fly2(2).tr2 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-08-29/20132908201134_stimulusTest/';

fly2(3).tr1 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-08-29/20132908204048_stimulusTest/';
fly2(3).tr2 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-08-29/20132908205916_stimulusTest/';

fly2(4).tr1 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-09-02/20130209171021_stimulusTest/';
fly2(4).tr2 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-09-02/20130209173519_stimulusTest/';

fly2(5).tr1 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-09-02/20130209175605_stimulusTest/';
fly2(5).tr2 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-09-02/20130209181311_stimulusTest/';

fly2(6).tr1 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-09-03/20130309093312_stimulusTest/';
fly2(6).tr2 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-09-03/20130309095539_stimulusTest/';

fly2(7).tr1 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-09-03/20130309102505_stimulusTest/';
fly2(7).tr2 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-09-03/20130309104709_stimulusTest/';

fly2(8).tr1 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-09-03/20130309134706_stimulusTest/';
fly2(8).tr2 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-09-03/20130309140425_stimulusTest/';

fly2(9).tr1 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-09-03/20130309152412_stimulusTest/';
fly2(9).tr2 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-09-03/20130309154251_stimulusTest/';

fly2(10).tr1 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-09-03/20130309205951_stimulusTest/';
fly2(10).tr2 = '/Volumes/flyplacememory/TJ/VR_Maze_Experiment_Data/temperaturePreference/2013-09-03/20130309212508_stimulusTest/';
...
control_colorSummaryMatrix = nan(10,30);
...
summaryPlotMatrix = [.4 .75 .8 .75;...
 ...
 control_summaryPlotMatrix = [.5  .5 .5 .75;... 1
                              .4  .75 .7 .75;... 2
                              .5  .0  .8 .75;... 3
                              .5  0   .5  1;... 4
                              .4  .75 .3  .25;... 5
...
text(4.2,.85, 'new flies (N = 10)', 'FontWeight', 'bold', 'Color', 'k')
