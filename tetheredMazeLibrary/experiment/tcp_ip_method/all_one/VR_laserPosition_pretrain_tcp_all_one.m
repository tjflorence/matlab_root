function [data_out] = VR_laserPosition_pretrain_tcp_all_one(input_tempEnv, experimentLength, exName,fileName,directory,XYstart,rotGain,sampleRate,info_input,acquire_images,ao_obj)
...
updateDisplay(normalizedX, normalizedY, data.flyTheta(data.count), 2) 
