...
%temperature cotnrol
experiment.protocol(3).temps = [35 50 35 25 35 35];
%camera control
...
%temperature cotnrol
experiment.protocol(4).temps = [35 50 35 35 25 35];
%camera control
...
%temperature cotnrol
experiment.protocol(5).temps = [35 50 35 25 35 35];
%camera control
...
%temperature cotnrol
experiment.protocol(6).temps = [35 50 35 35 25 35];
%camera control
...
%temperature cotnrol
experiment.protocol(7).temps = [35 50 35 35 35 25];
%camera control
...
%temperature cotnrol
experiment.protocol(8).temps = [35 50 35 35 25 35];
%camera control
...
%temperature cotnrol
experiment.protocol(9).temps = [35 50 35 35 35 25];
%camera control
