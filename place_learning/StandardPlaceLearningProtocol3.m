...
experiment.protocol(2).pattern_position = [disp4, 1];
%temperature cotnrol
experiment.protocol(2).temps = [floorT ringT tq1 tq2 tq3 cool4];
%camera control
...
experiment.protocol(3).pattern_position = [disp1, 1];
%temperature cotnrol
experiment.protocol(3).temps = [floorT ringT cool1 tq2 tq3 tq4];
%camera control
...
experiment.protocol(4).pattern_position = [disp2, 1];
%temperature cotnrol
experiment.protocol(4).temps = [floorT ringT tq1 cool2 tq3 tq4];
%camera control
...
experiment.protocol(5).pattern_position = [disp1, 1];
%temperature cotnrol
experiment.protocol(5).temps = [floorT ringT cool1 tq2 tq3 tq4];
%camera control
...
experiment.protocol(6).pattern_position = [disp2, 1];
%temperature cotnrol
experiment.protocol(6).temps = [floorT ringT tq1 cool2 tq3 tq4];
%camera control
...
experiment.protocol(7).pattern_position = [disp3, 1];
%temperature cotnrol
experiment.protocol(7).temps = [floorT ringT tq1 tq2 cool3 tq4];
%camera control
...
experiment.protocol(8).pattern_position = [disp2, 1];
%temperature cotnrol
experiment.protocol(8).temps = [floorT ringT tq1 cool2 tq3 tq4];
%camera control
...
experiment.protocol(9).pattern_position = [disp3, 1];
%temperature cotnrol
experiment.protocol(9).temps = [floorT ringT tq1 tq2 cool3 tq4];
%camera control
...
experiment.protocol(10).pattern_position = [disp4, 1];
%temperature cotnrol
experiment.protocol(10).temps = [floorT ringT tq1 tq2 tq3 cool4];
%camera control
...
experiment.protocol(11).pattern_position = [disp3, 1];
%temperature cotnrol
experiment.protocol(11).temps = [floorT ringT tq1 tq2 cool3 tq4]
...
experiment.protocol(12).pattern_position = [disp2, 1];
%temperature cotnrol
...
%save('StandardPlaceLearningProtocol49e.mat', 'experiment');
save('StandardPlaceLearningProtocol270bdeg.mat', 'experiment');
